...
type PrefillStore = {
  prefillMap: Record<
    ...
    Record<
      ...
      { node_id: NodeID; property: FieldSchemaPropertyName }
    >
  >;
  setPrefill: (
    node_id: NodeID,
      ...
      prefillMap: {
        ...
        [node_id]: {
          ...
          [property_name]: {
            ...
            property: mapped_property_name,
          },
        },
      },
    })),
  removePrefill: (node_id: NodeID, property_name: FieldSchemaPropertyName) =>
    set((state) => {
      const { [property_name]: _, ...nodeWithoutProperty } =
        state.prefillMap[node_id];
      return {
        prefillMap: {
          ...state.prefillMap,
